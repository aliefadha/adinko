...
export const Route = createFileRoute("/_public/adinko")({
	...
	loader: async () => {
		const [perusahaanRes, tagRes, alasanRes, imageRes, layananRes] =
			await Promise.all([
				getPerusahaanByNama({ data: { nama: "Adinko" } }),
				getPerusahaanTag({ data: { nama: "Adinko" } }),
				getPerusahaanAlasan({ data: { nama: "Adinko" } }),
				getPerusahaanImage({ data: { nama: "Adinko" } }),
				getPerusahaanLayanan({ data: { nama: "Adinko" } }),
			]);
		return {
...
function RouteComponent() {
	...
	const carouselSlides =
		images.length > 0
			? images.map((img) => ({ src: img.image, alt: "Adinko image" }))
			: [
				...
				<div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
					...
					<div className="flex flex-col gap-6">
						...
						<p className="text-sm text-gray-600 leading-relaxed">
							...
							telah dipercaya oleh berbagai klien. Kami fokus pada kualitas
							material, kerapian pengerjaan, dan hasil akhir yang estetis serta
							tahan lama.
						</p>
						...
						<div className="flex flex-wrap gap-2">
							{tags.length > 0
								...
								: ["Rumput Sintetis", "Vertikal & Garden Sintetis"].map(
									(tab, i) => (
										<button
											key={tab}
											type="button"
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid lg:grid-cols-2 gap-6">
						...
						<div className="flex flex-col gap-4">
							...
							{/* Misi */}
							<div className="rounded-2xl bg-[#518100] p-6 flex-1 flex flex-col justify-end">
								<p className="font-bold text-white mb-4 text-lg">Misi Kami</p>
