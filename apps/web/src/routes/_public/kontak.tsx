			...
			<section id="kontak" className="bg-white py-16 px-6 sm:px-10 lg:px-20">
				<div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10">
						...
						<div className="flex flex-col gap-5">
							...
							<div className="flex gap-3">
								<span className="flex items-center justify-center w-9 h-9 rounded-full bg-[#518100] text-white shrink-0 mt-0.5">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path fillRule="evenodd" d="m11.54 22.351.07.04.028.016a.76.76 0 0 0 .723 0l.028-.015.07-.041a16.975 16.975 0 0 0 1.144-.742 19.58 19.58 0 0 0 2.683-2.282c1.944-2.003 3.5-4.697 3.5-8.327a8 8 0 0 0-16 0c0 3.63 1.556 6.326 3.5 8.327a19.58 19.58 0 0 0 2.682 2.282 16.975 16.975 0 0 0 1.144.742ZM12 13.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clipRule="evenodd"/></svg>
								</span>
								<div>
									<p className="font-bold text-gray-900 text-sm">Alamat</p>
									<p className="text-sm text-gray-500 mt-0.5">Jl. Todak No.113 Tangkerang Barat,<br />Kec Marpoyan Damai, Kota Pekanbaru, Riau</p>
								</div>
							</div>
							...
							<div className="flex gap-3">
								<span className="flex items-center justify-center w-9 h-9 rounded-full bg-[#518100] text-white shrink-0 mt-0.5">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.555 4.116 1.528 5.845L.057 23.428a.5.5 0 0 0 .609.61l5.652-1.464A11.945 11.945 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.9a9.878 9.878 0 0 1-5.031-1.376l-.36-.214-3.733.967.994-3.638-.234-.374A9.86 9.86 0 0 1 2.1 12C2.1 6.533 6.533 2.1 12 2.1S21.9 6.533 21.9 12 17.467 21.9 12 21.9z"/></svg>
								</span>
								<div>
									<p className="font-bold text-gray-900 text-sm">WhatsApp</p>
									<p className="text-sm text-gray-500 mt-0.5">0852-6445-6566 (Adinko)<br />0813 8894-1740</p>
									<p className="text-sm text-gray-500 mt-1">0852-6445-6566 (GhaziSportsHub)</p>
								</div>
							</div>
							...
							<div className="flex gap-3">
								...
								<div>
									...
									<p className="text-sm text-gray-500 mt-0.5">@adinko.pekanbaru<br />@ghazisportshub</p>
								</div>
							</div>
						</div>
					...
					<div className="bg-[#F1F2F6] rounded-3xl p-8 flex flex-col gap-5">
						<h2 className="text-xl font-bold text-gray-900">Kirim Pesan Sekarang</h2>
						...
						<div className="flex flex-col gap-4">
							...
							<div>
								<label className="block text-sm font-medium text-gray-700 mb-1.5">Lokasi Proyek</label>
								<input
									id="kontak-lokasi"
									type="text"
							...
							<div>
								<label className="block text-sm font-medium text-gray-700 mb-1.5">Kebutuhan Anda</label>
