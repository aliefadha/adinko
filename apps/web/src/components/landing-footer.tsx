		...
		>
			...
			<div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-20 py-16 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12">
				...
				<div className="flex flex-col gap-5 max-w-xs lg:max-w-xs">
					...
					<div>
						...
						<p className="mt-2 text-sm text-white/60 leading-relaxed">
							Penyedia solusi rumput sintetis dan fasilitas olahraga profesional terbaik
							di Pekanbaru & Riau.
						</p>
						<p className="mt-3 text-sm text-white/50">Dipercaya oleh 1000+ klien.</p>
					</div>
				...
				<div className="grid sm:grid-cols-3 gap-8 lg:gap-10">
					...
					{/* GhaziSportsHub */}
					<div>
						<p className="text-sm font-bold mb-5 tracking-wide">GhaziSportsHub</p>
						<ul className="flex flex-col gap-3">
							{ghaziLinks.map((l) => (
								<li key={l.label}>
									<a href={l.href} className="text-sm text-white/60 hover:text-white transition-colors">
