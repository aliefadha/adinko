      ...
      >
        ...
        <div className="flex items-center justify-between gap-6 rounded-full bg-white px-4  shadow-lg">
          ...
          <Link
            to="/"
            id="nav-konsultasi"
            className="hidden lg:flex items-center gap-2 shrink-0 rounded-full bg-[#518100] px-5 py-2.5  font-semibold text-white hover:bg-[#518100]/80 active:scale-95 transition-all"
          >
            Konsultasi
        ...
        >
          <nav className="flex flex-col py-3 px-2">
            ...
            <div className="px-2 pt-2 pb-1">
              <Link
                to="/"
                id="nav-mobile-konsultasi"
                onClick={closeMobile}
                className="flex items-center justify-center gap-2 w-full rounded-full bg-[#518100] px-5 py-3.5 font-semibold text-white hover:bg-[#518100]/80 active:scale-95 transition-all"
              >
                Konsultasi
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-[#E0D28F] text-[#518100]">
                  <ArrowRight size={13} />
